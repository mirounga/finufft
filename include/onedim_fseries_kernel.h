...
#ifdef __AVX2__
template<>
inline void onedim_fseries_kernel<double>(BIGINT nf, double* fwkerhalf, spread_opts opts)
{
...
template<>
inline void onedim_fseries_kernel<float>(BIGINT nf, float* fwkerhalf, spread_opts opts)
{
