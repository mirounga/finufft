	...
	BIGINT begin, BIGINT end, const spread_opts& opts)
{
	...
	float* du1 = (float*)scalable_aligned_malloc(sizeof(float) * 2 * (size1 * size2  + MAX_NSPREAD), 64);
	float* du2 = (float*)scalable_aligned_malloc(sizeof(float) * 2 * (size1 * size2  + MAX_NSPREAD), 64);
	float* du3 = (float*)scalable_aligned_malloc(sizeof(float) * 2 * (size1 * size2  + MAX_NSPREAD), 64);
